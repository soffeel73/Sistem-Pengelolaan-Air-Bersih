...
<template>
  <footer class="bg-gray-900 text-white pt-20 pb-10" data-aos="fade-up" data-aos-offset="0">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        <!-- Brand -->
        <div class="space-y-6">
          <div class="flex items-center gap-3">
            <img src="@/assets/logo.png" alt="Logo HIPPAMS" class="w-12 h-12 object-contain">
            <span class="font-bold text-2xl tracking-tight">HIPPAMS <span class="text-primary">Tirto Joyo</span></span>
          </div>
          <p class="text-gray-400 text-sm leading-relaxed">
            Pelayanan air bersih untuk masyarakat Dusun Gempolpayung yang transparan, akuntabel, dan terpercaya.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-4 text-sm text-gray-400">
            ...
            <li><a href="#" class="hover:text-primary transition-colors">Fitur Lengkap</a></li>
        ...
        <div>
          ...
          <ul class="space-y-4 text-sm text-gray-400">
            <li><a href="#" class="hover:text-primary transition-colors">Cek Tagihan</a></li>
            <li><a href="#" class="hover:text-primary transition-colors">Panduan Pembayaran</a></li>
            <li><a href="#" class="hover:text-primary transition-colors">Layanan Pengaduan</a></li>
        ...
        <div>
          ...
          <ul class="space-y-4 text-sm text-gray-400">
            <li class="flex items-start gap-3">
              ...
              <span>Dusun Gempolpayung Desa Gempoltukmloko Kec. Sarirejo Kab. Lamongan</span>
            </li>
            <li class="flex items-center gap-3">
              ...
              <span>hippamstirtojoyo@gmail.com</span>
            </li>
            <li class="flex items-center gap-3">
      ...
      <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <p class="text-gray-500 text-sm">Copyright © 2026 HIPPAMS Tirto Joyo. All rights reserved.</p>
